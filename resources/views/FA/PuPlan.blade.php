        ...
        <div id="div1" class="row">
            <div class="col-lg-2" style="background-color:whitesmoke;">
                ...
                <div class="form-group">
                 ...
                 Type    <input id="report_type" name="report_type" class="form-control" value="{{old('report_type')}}" >
                 Sales Team  <input id="sales_team" name="sales_team" class="form-control" value="{{old('sales_team')}}" >
                 ...
                 HMD Product Only <input id="hmd_product" name ="hmd_product" class = "form-control" value="{{old('hmd_product')}}"   >
...
$(document).ready(function() {
    ...
    var report_type = $("#report_type").data("kendoDropDownList");
...
//======================================================
    ...
    var dsSalesTeam = [
        ...
        $("#sales_team").kendoDropDownList({
        dataTextField: "text",
        dataValueField: "value",
        dataSource: dsSalesTeam,
        index: 0,
        change: onSalesTeamChange
        });

        var SalesTeam = $("#sales_team").data("kendoDropDownList");

        function onSalesTeamChange(){
        var value = $("#sales_team").val();
        };
     //======================================================
     var dsHmdProduct = [
        { text: "False", value: "0" },
        ...
        $("#hmd_product").kendoDropDownList({
        dataTextField: "text",
        dataValueField: "value",
        dataSource: dsHmdProduct,
        index: 0,
        change: onHmdProductChange
        });

        var HmdProduct = $("#hmd_product").data("kendoDropDownList");

        function onHmdProductChange(){
        var value = $("#hmd_product").val();
        };
    //======================================================
    ...
    ({
        ...
        columns:
            [
                ...
                {title: "title ", field: "title", width:4*ColWitdh },
                ...
                {title: "commission", field: "commission", width:ColWitdh,format: "{0:n0}", footerTemplate: " #= kendo.toString(sum, '0,00')#"  },
                {title: "vine", field: "vine", width:ColWitdh,format: "{0:n0}", footerTemplate: " #= kendo.toString(sum, '0,00')#"  },
