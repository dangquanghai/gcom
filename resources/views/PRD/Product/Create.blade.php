                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name"name="name" class="form-control @error('name') is-invalid @enderror"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type ="text" class="form-control" name="width" id="width" placeholder="Rộng">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="length">Length</label>
                                <input type="text" class ="form-control" name="length" id="length" placeholder="Độ dài">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <img width="auto" height="auto" class="image-review"
                                    alt="url_img"
                                    src="{{!empty(old('url_img')) ? old('url_img') : 'http://placehold.it/270x200' }}"
                                    onclick="OpenServerBrowser('{!! route('unisharp.lfm.show') !!}?view=images',
                                                            screen.width * 1,
                                                            screen.height * 1);">
                                <input type="hidden" class="form-control" name="url_img" id="url_img" value="{{ old('url_img') }}">
                            </div>
                        </div>
                    </div>
                </div>
