                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="height" id="height" value="{{$dsProduct->the_height}} " >
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="width">Width</label>
                                <input type="number" class="form-control" name="width" id="width" value="{{$dsProduct->the_width}} "  >
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="length" id="length" value="{{$dsProduct->the_length}} " >
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="weight" id="the_weight" value="{{$dsProduct->the_weight}} " >
                            </div>
                        </div>
                    </div>
                    <hr>
...
$(document).on('change','#channel_name_select',function(){
    ...
    $("#channel_id_add").text(ChannelId);
});


$(document).on('click','#Addbtn',function(){
var Sku =  document.getElementById("sku").value;
var ChannelID =  document.getElementById("channel_id_add").value;
 console.log(Sku);
...
{
    $.ajax({
                url:'{{route("SalesProductInforController.SaveNewChannelCostAndPrice")}}',
                method: "POST",
                data: {sku:Sku,channel_id:ChannelID, _token:_token},
                success:function(data)
                {
                    $('#message').html("<div class='alert alert-danger'>Lỗi từ insert channel price</div>");
                }
            });
}
