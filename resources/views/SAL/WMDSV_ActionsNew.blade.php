            ...
            data-response-handler="responseHandler">
              <thead>
                <tr>
                  ...
                  <th>cost</th>
                  <th>price</th>
                  <th>avl_unit_in_wh</th>
                  <th>avl_unit_on_wm</th>
                </tr>
              </thead>
              <tbody>
                @if($dsOutOfStocks)
                  @foreach ( $dsOutOfStocks as $p )
                    <tr>
                      <td>{{$p->id}}</td>
                      <td>{{$p->sku}}</td>
                      <td> <a href="https://www.walmart.com/ip/{{$p->item_id}}"> {{$p->product_name}} </a></td>
                      <td>{{$p->cogs}}</td>
                      <td>{{$p->cost}}</td>
                      <td>{{$p->price}}</td>
                      <td>{{$p->avl_unit_in_wh}}</td>
                      <td>{{$p->avl_unit_on_wm}}</td>
                    </tr>
                  @endforeach
                @endif
                </tbody>
