...
// ============================================================================================================
 ...
 public function CheckExistingSkuInMemo($Memo)
 {
  ...
  {
/*
    $TransactionID='111-7673347-1028255';
    $Memo ='4x Weight - 1.15in - 5lb of DB - 200 lbs - Package 3' ;
    $MemoBa='PART.ZZE3';
    ...
    print_r('<br>');
*/
    if($this->CheckExistingSkuInMemo($Memo))  {  $Memo = $MemoBa; }
    ...
    if(strlen( $Memo)>0 )// nếu còn ký tự
    {
      ...
      if( $Count == 1)// Chỉ có một sku
      {
        ...
        {
          $dataSKUAndQuantity = explode('x',$Memo,2);
          $sku = $dataSKUAndQuantity[0];
          $Quantity = $dataSKUAndQuantity[1];
          print_r( 'Memo:'. $Memo. ' Transaction : '.$TransactionID);
          print_r('<br>');
   ...
   {//$Letter, $String
    $StartPost = strpos($String, $Letter, 0);
    $EndPost=strlen($String);
    $sTemp = substr($String,$StartPost,$EndPost - $StartPost + 1);
